...
export const HomePage: React.FC<HomePageProps> = ({
  ...
  return (
    <div className="w-full min-h-[calc(100vh-80px)] bg-[#0B0B0C] text-[#E0E0E0] select-none py-4 sm:py-5 px-4 sm:px-6 lg:px-8 space-y-5 sm:space-y-6 max-w-[1500px] mx-auto">
      ...
      <section id="dashboard-hero-header" className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#0F1D16] via-[#0F0F11] to-[#0A120D] border border-emerald-500/20 shadow-xl p-5 sm:p-7 flex flex-col items-center justify-center text-center gap-4">
